...
{
	CameraError error = [self usbConnectToCam:usbLocationId configIdx:0];
...
#if 0 //DEBUG
    [histogram setView:[(ViewController *) [[self central] delegate] getHistogramView]];
#endif
...
/*
    if (ok) 
    {
        ...
        dispatch_async(dispatch_get_main_queue(),^ {
            [self.histogram draw];  // update histogram if necessary, draw in view already specified
        } );
    }
*/
    [displayFPS addFrame];

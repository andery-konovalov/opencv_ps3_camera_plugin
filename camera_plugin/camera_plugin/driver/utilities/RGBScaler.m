...
void ScaleRowRGBToRGB (unsigned char* src, unsigned char* dst, int srcLength, int dstLength)
#define SRC_RGB
#define DST_RGB
#define SCALE_ROW
#include "RGBScalerIncluded.h"
...
void ScaleRowRGBAToRGB (unsigned char* src, unsigned char* dst, int srcLength, int dstLength)
#define SRC_RGBA
#define DST_RGB
#define SCALE_ROW
#include "RGBScalerIncluded.h"
...
void ScaleRowRGBToRGBA (unsigned char* src, unsigned char* dst, int srcLength, int dstLength)
#define SRC_RGB
#define DST_RGBA
#define SCALE_ROW
#include "RGBScalerIncluded.h"
...
void ScaleRowRGBAToRGBA (unsigned char* src, unsigned char* dst, int srcLength, int dstLength)
#define SRC_RGBA
#define DST_RGBA
#define SCALE_ROW
#include "RGBScalerIncluded.h"
...
void BlendRowsToRGB (unsigned char* r1,unsigned char* r2,int w1, int w2, int len, unsigned char* dst)
#define DST_RGB
#define BLEND_ROWS
#include "RGBScalerIncluded.h"
#undef DST_RGB
...
//2-Row mixing functions
void BlendRowsToRGBA (unsigned char* r1,unsigned char* r2,int w1, int w2, int len, unsigned char* dst)
#define DST_RGBA
#define BLEND_ROWS
#include "RGBScalerIncluded.h"
#undef DST_RGBA
